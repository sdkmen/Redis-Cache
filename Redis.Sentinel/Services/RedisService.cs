...
namespace Redis.Sentinel.Services
{
    public class RedisService
    {
        ...
        //Gets the master database by checks from sentinels
        static public async Task<IDatabase> RedisMasterDatabase()
        {
            ConnectionMultiplexer sentinelConnection = await ConnectionMultiplexer
                .SentinelConnectAsync(sentinelOptions);
